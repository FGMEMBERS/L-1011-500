...
var switch = props.globals.getNode("sim/model/L1011-500/controls/canopy/canopy-switch", 1);
...
var cockpit_state = func {
	var switch = getprop("sim/model/L1011-500/controls/canopy/canopy-switch");
	if ( switch == 1 ) {
